...
public class InventoryObserverContext implements ObserverContext {

    @Nonnull private final UUID playerIdentifier;

    public InventoryObserverContext(@Nonnull final UUID playerIdentifier) {
